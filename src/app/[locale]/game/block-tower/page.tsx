    ...
    })),
  {
    ...
    loading: () => (
      <div className="flex size-full items-center justify-center bg-gray-900 text-white">
        <p className="animate-pulse text-xl">Loading Block Tower...</p>
      </div>
    ),
  },
);

const BlockTowerPage = () => {
  ...
  const containerStyle = isMobile
    ...
    : {
        maxWidth: `${BlockTowerConstants.MAX_WIDTH}px`,
        maxHeight: "calc(100% - 8px)",
        aspectRatio: BlockTowerConstants.ASPECT_RATIO_CSS,
      };
      ...
      >
        {gameState === "ready" && (
          <div className="absolute inset-0 z-20">
            <BlockTowerReadyScreen onStart={handleStart} isMobile={isMobile} />
          </div>
        )}
