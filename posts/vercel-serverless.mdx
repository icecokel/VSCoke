...
- 흐름
  ...
  ![Untitled](vercel%20serverless%20function,%20cache%202e2669ec78c246dcb387e05f38f6974d/Untitled.png)
...
## [Cache](https://nextjs.org/docs/app/building-your-application/data-fetching/fetching-caching-and-revalidating)
...
### **[x-vercel-cache](https://vercel.com/docs/edge-network/headers#x-vercel-cache)**

**MISS** : edge-network-cache에서 찾지 못하고 origin server에서 응답이 제공

![Untitled](vercel%20serverless%20function,%20cache%202e2669ec78c246dcb387e05f38f6974d/Untitled%201.png)

**HIT** : edge-network-cache에서 응답이 제공

![Untitled](vercel%20serverless%20function,%20cache%202e2669ec78c246dcb387e05f38f6974d/Untitled%202.png)

**STALE** : edge-network-cache에서 응답이 제공, edge-cache에 데이터를 업데이트

![Untitled](vercel%20serverless%20function,%20cache%202e2669ec78c246dcb387e05f38f6974d/Untitled%203.png)

**PRERENDER** : 정적 저장소에서 응답이 제공

![Untitled](vercel%20serverless%20function,%20cache%202e2669ec78c246dcb387e05f38f6974d/Untitled%204.png)

**REVIALIDATED** : origin-server에서 응답이 제공되었으며 수신 요청에서 사용자의 인증으로 인해 캐시가 새로 고쳐졌습니다 .

![Untitled](vercel%20serverless%20function,%20cache%202e2669ec78c246dcb387e05f38f6974d/Untitled%205.png)

**BYPASS** : 캐시가 우회되어 origin-sever에서 응답이 제공되었습니다.

![Untitled](vercel%20serverless%20function,%20cache%202e2669ec78c246dcb387e05f38f6974d/Untitled%206.png)
