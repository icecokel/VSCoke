...
6. `~/projects/vscoke-api/.env`가 있는지 확인한다.
7. `~/projects/vscoke-api`에서 production 의존성을 설치하고 PM2로 API를 재기동한다.
8. Termux 내부 `http://127.0.0.1:$PORT/api-json`와 공개 `API_HEALTH_URL`을 smoke test한다.
