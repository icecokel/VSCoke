...
const nodes = [
  {
    ...
    children: [
      {
        type: "text",
        value: "TypeScript와 Express-session으로 로그인 처리하기 (1): 안전한 세션 설정",
      },
    ],
  },
  {
  ...
  },
  {
    type: "heading",
    depth: 2,
    children: [{ type: "text", value: "세션 저장소와 비밀값" }],
  },
  {
    type: "paragraph",
    children: [
        ...
        children: [
          {
            type: "paragraph",
            children: [
              { type: "inlineCode", value: "saveUninitialized: false" },
              { type: "text", value: "는 로그인 전의 빈 세션 쿠키를 만들지 않습니다." },
            ],
          },
        ],
      },
        ...
        children: [
          {
            type: "paragraph",
            children: [
              { type: "inlineCode", value: "httpOnly" },
              { type: "text", value: "는 클라이언트 JavaScript의 쿠키 접근을 막고, " },
              { type: "inlineCode", value: "sameSite" },
              { type: "text", value: "는 CSRF 위험을 낮춥니다." },
            ],
          },
        ],
      },
        ...
        children: [
          {
            type: "paragraph",
            children: [
              { type: "inlineCode", value: "secure: true" },
              {
                type: "text",
                value:
                  "는 HTTPS에서만 사용해야 합니다. TLS 종료 프록시 뒤라면 Express trust proxy 설정도 함께 검토하세요.",
              },
            ],
          },
        ],
  ...
  },
  {
    type: "heading",
    depth: 2,
    children: [{ type: "text", value: "세션에 저장할 값" }],
  },
  {
    type: "paragraph",
    children: [
