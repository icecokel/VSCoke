...
const nodes = [
  {
    ...
    children: [
      {
        type: "text",
        value: "TypeScript와 Express-session으로 로그인 처리하기 (3): 로그인 유지와 로그아웃",
      },
    ],
  },
  {
  ...
  },
  {
    type: "heading",
    depth: 2,
    children: [{ type: "text", value: "remember-me 수명 설정" }],
  },
  {
    type: "code",
    language: "typescript",
  ...
  },
  {
    type: "heading",
    depth: 2,
    children: [{ type: "text", value: "로그아웃은 쿠키와 서버 세션을 함께 지운다" }],
  },
  {
    type: "code",
    language: "typescript",
  ...
  },
  {
    type: "heading",
    depth: 2,
    children: [{ type: "text", value: "점검 목록" }],
  },
  {
    type: "list",
    ordered: false,
    ...
    children: [
      {
        ...
        children: [
          {
            type: "paragraph",
            children: [{ type: "text", value: "운영 환경은 HTTPS와 secure cookie를 사용한다." }],
          },
        ],
      },
      {
        ...
        children: [
          {
            type: "paragraph",
            children: [{ type: "text", value: "세션 ID는 로그인 성공 시 재발급한다." }],
          },
        ],
      },
      {
        ...
        children: [
          {
            ...
            children: [
              {
                type: "text",
                value: "만료·로그아웃·비밀번호 변경 시 서버 저장소의 세션도 제거한다.",
              },
            ],
          },
        ],
