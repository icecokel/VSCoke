...
const nodes = [
    ...
    children: [
      {
        ...
        children: [
          {
            type: "text",
            value: "1. window.innerWidth, window.innerHeight",
          },
        ],
      },
    ],
  },
  {
    ...
    children: [
      {
        type: "text",
        value: "현재 열려있는 윈도우(창)의 크기를 구하는 Web Api 입니다.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    children: [
      ...
      {
        type: "link",
        url: "https://codepen.io/icecokel/pen/JjpmdpB",
        title: null,
        children: [
          {
            type: "text",
    ...
    children: [
      {
        ...
        children: [
          {
            type: "text",
            value: "3. window.URL.createObjectURL",
          },
        ],
      },
    ],
  },
  {
    ...
    children: [
      ...
      {
        type: "text",
        value: "createObjectURL는 함수 입니다. 매개변수의 타입은 File, Blob 입니다.",
      },
    ],
  },
  {
    ...
    children: [
      {
        type: "text",
        value: "createObjectURL(File)을 사용하면, 말그대로 file의 url를 생성할수 있는데요. ",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        type: "text",
        value:
          "인데요. **일단 파일객체를 생성한 document가 사라지면 같이 사라집니다.** 생성한 url를 db에 저장해도 다시 사용할수 없다는 말입니다.",
      },
    ],
  },
  {
