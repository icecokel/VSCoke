...
const nodes = [
  {
    ...
    children: [
      {
        type: "text",
        value: "코드 저장소 밖의 동료를 위해 Wiki MCP를 만든 기록",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    children: [
      {
        type: "text",
        value: "1. 고민과 문제점: 저장소 안에서만 통하던 지식",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    children: [
      {
        type: "text",
        value: "그래서 개발팀은 저장소 안에 다음과 같은 지식을 문서로 남기고 있었다.",
      },
    ],
  },
  {
        ...
        children: [
          {
            ...
            children: [
              {
                type: "text",
                value: "과거에 어떤 선택을 했고 왜 그렇게 결정했는지",
              },
            ],
          },
        ],
  ...
  },
  {
    ...
    children: [
      {
        type: "text",
        value: "하지만 디자이너는 같은 도움을 받을 수 없었다",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    children: [
      {
        type: "text",
        value: "디자이너가 Claude를 사용하는 모습을 보고 떠오른 생각",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    children: [
      {
        type: "text",
        value: "2. 선택지 분석: RAG부터 만들 필요가 있을까",
      },
    ],
  },
  {
    ...
    children: [
      {
        type: "text",
        value: "처음에는 벡터 검색 중심의 RAG를 생각했다",
      },
    ],
  },
  {
        ...
        children: [
          {
            ...
            children: [
              {
                type: "text",
                value: "문서가 수정됐을 때 인덱스를 어떻게 동기화할 것인지",
              },
            ],
          },
        ],
        ...
        children: [
          {
            ...
            children: [
              {
                type: "text",
                value: "모델과 데이터베이스의 운영 비용을 어떻게 관리할 것인지",
              },
            ],
          },
        ],
    ...
    children: [
      {
        type: "text",
        value:
          "무엇보다 아직 사용성이 검증되지 않았다. 디자이너가 실제로 자주 사용할지, 어떤 질문을 할지, 지금 모은 문서가 업무에 얼마나 도움이 될지 알 수 없는 상태였다.",
      },
    ],
  },
  {
    ...
    children: [
      {
        type: "text",
        value:
          "사용되지 않을 수도 있는 기능에 처음부터 많은 자원을 투자하고 싶지는 않았다. 검색 기술을 고도화하기 전에 이 Wiki가 정말 필요한지부터 확인하는 편이 맞다고 판단했다.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    children: [
      {
        type: "text",
        value: "MCP는 답변하는 AI가 아니라 연결 규격이었다",
      },
    ],
  },
  {
    ...
    children: [
      {
        type: "text",
        value:
          "구현 과정에서 크게 어려운 문제는 없었다. 처음부터 기능을 많이 넣지 않았고, MCP 서버의 책임을 문서 검색과 원문 열람으로 제한했기 때문이다.",
      },
    ],
  },
  {
    ...
    children: [
      {
        type: "text",
        value: "먼저 첫 버전이 해야 할 일과 하지 않을 일을 구분했다.",
      },
    ],
  },
  {
        ...
        children: [
          {
            ...
            children: [
              {
                type: "text",
                value: "기획서와 히스토리 문서를 Markdown으로 정리한다.",
              },
            ],
          },
        ],
        ...
        children: [
          {
            ...
            children: [
              {
                type: "text",
                value: "Markdown을 지식의 유일한 원본으로 사용한다.",
              },
            ],
          },
        ],
        ...
        children: [
          {
            ...
            children: [
              {
                type: "text",
                value: "MCP 서버는 문서 목록, 검색, 관련 문서 조회와 원문 열람만 제공한다.",
              },
            ],
          },
        ],
        ...
        children: [
          {
            ...
            children: [
              {
                type: "text",
                value: "문서를 생성하거나 수정하거나 삭제하는 기능은 제공하지 않는다.",
              },
            ],
          },
        ],
        ...
        children: [
          {
            ...
            children: [
              {
                type: "text",
                value: "실제 사용 사례가 생기기 전에는 벡터 검색과 관리자 화면을 만들지 않는다.",
              },
            ],
          },
        ],
  ...
  },
  {
    type: "code",
    language: "text",
    value: "knowledge://documents/nexus-patient-analysis-flow",
  },
  {
    type: "heading",
    depth: 3,
  ...
  },
  {
    ...
    children: [
      {
        type: "text",
        value: "단순히 확장자만 바꾼 것이 아니라 검색에 필요한 기준을 문서마다 맞췄다.",
      },
    ],
  },
  {
        ...
        children: [
          {
            ...
            children: [
              {
                type: "text",
                value: "개념, 정책, 업무 흐름처럼 문서 유형을 나눴다.",
              },
            ],
          },
        ],
        ...
        children: [
          {
            ...
            children: [
              {
                type: "text",
                value: "정보의 최신성을 판단할 수 있도록 수정일을 기록했다.",
              },
            ],
          },
        ],
    ...
    children: [
      {
        type: "text",
        value:
          "첫 버전에서는 서버 내부 LLM, 벡터 데이터베이스, 임베딩 파이프라인, 관리자 웹 UI, 별도 지식 데이터베이스와 자동 문서 생성 기능을 의도적으로 제외했다.",
      },
    ],
  },
  {
    ...
    children: [
      {
        type: "text",
        value:
          "기술적으로 만들 수 없어서가 아니라 아직 이 실험에 필요하다는 근거가 없었기 때문이다. 먼저 작은 읽기 경로를 열고, 실제로 사용되는지를 확인하는 것이 이번 작업의 목적이었다.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    children: [
      {
        type: "text",
        value: "앞으로는 다음 내용을 지속적으로 살펴볼 필요가 있다.",
      },
    ],
  },
  {
        ...
        children: [
          {
            ...
            children: [
              {
                type: "text",
                value: "디자이너가 실제로 Wiki MCP를 사용하는가",
              },
            ],
          },
        ],
        ...
        children: [
          {
            ...
            children: [
              {
                type: "text",
                value: "검색 결과에서 원하는 문서를 찾지 못하는 경우는 무엇인가",
              },
            ],
          },
        ],
        ...
        children: [
          {
            ...
            children: [
              {
                type: "text",
                value: "문서가 수정된 뒤에도 최신 상태가 잘 유지되는가",
              },
            ],
          },
        ],
        ...
        children: [
          {
            ...
            children: [
              {
                type: "text",
                value: "AI의 답변에서 근거 문서를 확인할 수 있는가",
              },
            ],
          },
        ],
    ...
    children: [
      {
        type: "text",
        value:
          "단순 검색의 한계가 반복해서 확인된다면 그때 벡터 검색을 검토할 수 있다. 사용자와 문서가 늘어나면 인증과 권한도 더 세분화해야 한다. 반대로 사용하지 않는다면 기능을 더 추가하기 전에 문서의 품질과 접근 방식을 다시 봐야 한다.",
      },
    ],
  },
  {
    ...
    children: [
      {
        ...
        children: [
          {
            type: "text",
            value: "지식을 가지고 있는 것과, 그 지식을 사용할 수 있는 것은 다르다.",
          },
        ],
      },
    ],
    ...
    children: [
      {
        type: "text",
        value:
          "Wiki MCP는 그 사이에 작은 통로를 만든 실험이다. 아직 이 통로가 얼마나 자주 사용될지는 알 수 없다. 그래서 지금 필요한 것은 더 많은 기능이 아니라 실제 사용을 지켜보고, 어디에서 도움이 되고 어디에서 막히는지 기록하는 일이라고 생각한다.",
      },
    ],
  },
