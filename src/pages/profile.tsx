  ...
  return (
    <Box className="flex flex-col gap-10">
          ...
          <Alert severity="info" icon={false} className="mt-5">
            ...
            <Tooltip title="이메일 보내기" placement="right">
              <Typography variant="body1" className="mb-3" fontWeight={700}>
                ...
                <PanToolAltOutlinedIcon className="rotate-[90deg] scale-y-[-1] ml-2" />
              </Typography>
            </Tooltip>
      ...
      <Box>
        ...
        <Divider className="border-white my-5" />
        <Typography>
          안녕하세요.
          <br />
        ...
        <Box>
          {SKILLS.map((item, index) => (
            <Chip
              ...
              size="small"
              variant="outlined"
              className="text-white mb-2 mr-2 hover:text-yellow-200 hover:border-yellow-200 select-none p-1"
            />
          ))}
        </Box>
      </Box>
