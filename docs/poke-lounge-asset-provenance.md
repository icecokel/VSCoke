...
| Public audio                              | `apps/web/public/assets/poke-lounge/audio/audio-manifest.json`, `apps/web/public/assets/poke-lounge/audio/sfx/button-confirm.mp3`, `apps/web/public/assets/poke-lounge/audio/sfx/button-cancel.mp3`, `apps/web/public/assets/poke-lounge/audio/sfx/battle-transition.mp3`, `apps/web/public/assets/poke-lounge/audio/sfx/battle-start.mp3`, `apps/web/public/assets/poke-lounge/audio/sfx/battle-hit.mp3`, `apps/web/public/assets/poke-lounge/audio/sfx/pokemon-faint.mp3`, `apps/web/public/assets/poke-lounge/audio/bgm/field-day.mp3`, `apps/web/public/assets/poke-lounge/audio/bgm/wild-battle.mp3` | Confirmed ROM-derived; owner decision required                       | `scripts/poke-lounge/audio-cues.json` names `data/roms/포켓몬스터 하트골드(K).nds`. `scripts/poke-lounge/render-audio-cues.py` reads the ROM/SDAT and converts the selected sequences to MP3; `audio-manifest.json` retains their SDAT sequence IDs. Replace with original/cleared audio or record written authorization before release.                                                                                                |
...
- `docs/superpowers/plans/2026-07-07-poke-lounge-sound-effects.md` already requires distribution-rights confirmation before committing extracted audio. No corresponding approval record was found.
...
`docs/poke-lounge-asset-provenance.json` records all 66 audited public files with local SHA-256 values and `rightsStatus: "blocked"`. `pnpm check:poke-lounge-provenance` validates the public-file coverage, hashes, source record, approval fields, and attribution fields. Its current failure is intentional: this document does not clear any asset.
